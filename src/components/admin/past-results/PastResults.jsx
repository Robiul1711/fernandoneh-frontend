    ...
    >
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#E8AC43] text-sm font-bold ml-1">
            {multiplier}
          </span>
        </div>
      </div>
...
const PastResults = () => {
  ...
  const results = [
    {
      date: "Mon, Apr 23, 2026",
      numbers: [1, 2, 4, 6, 8, 6],
      multiplier: "3x",
    },
    {
      date: "Mon, Apr 24, 2026",
      numbers: [1, 2, 4, 6, 8, 6],
      multiplier: "3x",
    },
    {
      date: "Mon, Apr 25, 2026",
      numbers: [1, 2, 4, 6, 8, 6],
      multiplier: "3x",
    },
    {
        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            <select
              ...
              className="bg-[#111111] border border-white/10 rounded-xl pl-10 pr-10 py-3 text-white text-sm font-medium appearance-none focus:outline-none focus:border-[#E8AC43]/50 transition-all cursor-pointer"
            >
            ...
            <Calendar
              className="absolute left-4 top-1/2 -translate-y-1/2 text-[#E8AC43]"
              size={16}
            />
            <ChevronDown
              className="absolute right-4 top-1/2 -translate-y-1/2 text-[#A1A1A1] pointer-events-none group-focus-within:rotate-180 transition-transform"
